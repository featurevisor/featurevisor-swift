...
public struct InstanceOptions {
    ...
    public init(bucketKeySeparator: String? = nil,
...
public class FeaturevisorInstance {
    ...
    public init(options: InstanceOptions) {
        // from options
        bucketKeySeparator = options.bucketKeySeparator ?? FeaturevisorInstance.DEFAULT_BUCKET_KEY_SEPARATOR
...
//            }
    ...
    private func evaluateFlag(featureKey: FeatureKey, context _: Context) -> Evaluation {
        ...
        Evaluation(featureKey: featureKey, reason: .allocated, bucketValue: nil, ruleKey: nil, error: nil, enabled: true, traffic: nil, sticky: nil, initial: nil, variation: nil, variationValue: nil, variableKey: nil, variableValue: nil, variableSchema: nil)
    }
