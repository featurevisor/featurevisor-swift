...
extension KeyedDecodingContainer {
    ...
    func decodeGroupSegmentIfPresent(forKey key: KeyedDecodingContainer<K>.Key) throws -> GroupSegment? {
        ...
        default:
            guard let data = stringifiedGroupSegment.data(using: .utf8) else {
                ...
                let context = DecodingError.Context(
                    ...
                    debugDescription: "Featurevisor: DataCorrupted when decoding: \(GroupSegment.self)")
